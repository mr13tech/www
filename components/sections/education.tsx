...
export const EducationSection = () => {
  return (
    <section id="education" className="snap-start snap-always h-screen w-full flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-8 sm:py-10 md:py-10 lg:py-8 xl:py-8 relative overflow-hidden">
      <EthSectionBg />
