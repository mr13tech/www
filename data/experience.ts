...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    duration: 'Ongoing',
    description:
      'Contributing infrastructure to an open-source initiative that verifies real-world environmental cleanups on-chain via impact NFTs.',
    achievements: [
      'Contributing smart contract and frontend work to verify cleanup actions on-chain',
      'Integrated Hypercerts (ERC-1155) for minting impact certificates after verified cleanups',
    ],
    techStack: ['Solidity', 'Hypercerts', 'IPFS', 'React', 'Next.js'],
    current: true,
  },
  {
    id: '0xkyc',
    ...
    duration: '~1 year',
    description:
      'Decentralized identity platform built on zero-knowledge proofs. Started at ETHWarsaw 2022 hackathon, secured pre-seed funding and joined a VC accelerator.',
    achievements: [
      'ETHWarsaw 2022: Co-founded and led technical architecture for ZK-based identity verification',
      'Secured pre-seed funding and acceptance into VC accelerator post-hackathon',
      'Designed ZK proof system allowing on-chain identity claims without exposing PII',
      'Transitioned to consulting role as the protocol matured',
    ],
    techStack: ['Zero-Knowledge Proofs', 'Circom', 'Solidity', 'React', 'Identity', 'TypeScript'],
    current: false,
  },
  {
    id: 'copernicspace',
